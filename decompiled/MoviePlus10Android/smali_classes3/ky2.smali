...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lky2;->b:[Ljava/lang/String;
...
.method private static b(Lorg/json/JSONObject;)Lky2$b;
    .locals 2

    .line 1
    sget-object p0, Lky2;->a:Landroid/view/WindowManager;
    ...
    sget-object v0, Lky2;->a:Landroid/view/WindowManager;
    ...
    invoke-static {v0}, Lky2;->a(I)F

    move-result v0

    iget p0, p0, Landroid/graphics/Point;->y:I

    invoke-static {p0}, Lky2;->a(I)F
    ...
    :goto_0
    new-instance v1, Lky2$b;

    invoke-direct {v1, v0, p0}, Lky2$b;-><init>(FF)V
...
.method public static c(IIII)Lorg/json/JSONObject;
    ...
    invoke-static {p1, p0}, Lnz2;->b(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public static d(Landroid/content/Context;)V
    ...
    sput-object p0, Lky2;->a:Landroid/view/WindowManager;

    :cond_0
    return-void
.end method

.method public static e(Lorg/json/JSONObject;Lku2$a;)V
    .locals 2

    .line 1
    invoke-virtual {p1}, Lku2$a;->a()Lzz2;

    new-instance v0, Lorg/json/JSONArray;

    invoke-direct {v0}, Lorg/json/JSONArray;-><init>()V

    invoke-virtual {p1}, Lku2$a;->b()Ljava/util/ArrayList;
...
.method public static f(Lorg/json/JSONObject;Lcom/iab/omid/library/unity3d/adsession/OutputDeviceStatus;)V
    .locals 1

    .line 1
    invoke-static {p1}, Lky2;->k(Lcom/iab/omid/library/unity3d/adsession/OutputDeviceStatus;)Z
...
.method private static k(Lcom/iab/omid/library/unity3d/adsession/OutputDeviceStatus;)Z
    .locals 1

    .line 1
    sget-object v0, Lky2$a;->a:[I
...
.method public static m(Lorg/json/JSONObject;)V
    ...
    .line 1
    invoke-static {p0}, Lky2;->b(Lorg/json/JSONObject;)Lky2$b;
...
.method private static o(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    :cond_0
    invoke-static {p0, p1}, Lky2;->l(Lorg/json/JSONArray;Lorg/json/JSONArray;)Z
    ...
    invoke-static {v3, v4}, Lky2;->u(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
...
.method private static s(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    .line 1
    sget-object v0, Lky2;->b:[Ljava/lang/String;
...
.method public static u(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    :cond_1
    invoke-static {p0, p1}, Lky2;->s(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lky2;->t(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lky2;->r(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lky2;->q(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lky2;->p(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lky2;->o(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
