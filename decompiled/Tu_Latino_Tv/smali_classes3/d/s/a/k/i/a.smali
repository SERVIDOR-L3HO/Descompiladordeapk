...
.method public static b(Landroid/content/Context;Z)Ld/j/b/c/h4;
    ...
    invoke-static {}, Ld/s/a/k/i/a;->i()Z
...
.method public static declared-synchronized c(Landroid/content/Context;)V
    ...
    const-class v0, Ld/s/a/k/i/a;

    monitor-enter v0

    :try_start_0
    sget-object v1, Ld/s/a/k/i/a;->d:Ld/j/b/c/c5/w;

    if-nez v1, :cond_0

    new-instance v1, Ld/j/b/c/c5/w;

    invoke-static {p0}, Ld/s/a/k/i/a;->e(Landroid/content/Context;)Ld/j/b/c/v4/b;
    ...
    invoke-static {p0}, Ld/s/a/k/i/a;->h(Landroid/content/Context;)Ld/j/b/c/i5/v$a;
    ...
    sput-object v1, Ld/s/a/k/i/a;->d:Ld/j/b/c/c5/w;
...
.method public static declared-synchronized d(Landroid/content/Context;)Ld/j/b/c/i5/v$a;
    ...
    :try_start_0
    sget-object v1, Ld/s/a/k/i/a;->a:Ld/j/b/c/i5/v$a;
    ...
    invoke-static {v1, p0}, Ld/s/a/k/i/a;->a(Ld/j/b/c/i5/v$a;Ld/j/b/c/i5/w0/b;)Ld/j/b/c/i5/w0/d$c;

    move-result-object p0

    sput-object p0, Ld/s/a/k/i/a;->a:Ld/j/b/c/i5/v$a;

    :cond_0
    sget-object p0, Ld/s/a/k/i/a;->a:Ld/j/b/c/i5/v$a;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized e(Landroid/content/Context;)Ld/j/b/c/v4/b;
    ...
    :try_start_0
    sget-object v1, Ld/s/a/k/i/a;->c:Ld/j/b/c/v4/b;
    ...
    sput-object v1, Ld/s/a/k/i/a;->c:Ld/j/b/c/v4/b;

    :cond_0
    sget-object p0, Ld/s/a/k/i/a;->c:Ld/j/b/c/v4/b;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized f(Landroid/content/Context;)Ld/j/b/c/c5/w;
    ...
    :try_start_0
    invoke-static {p0}, Ld/s/a/k/i/a;->c(Landroid/content/Context;)V

    sget-object p0, Ld/s/a/k/i/a;->d:Ld/j/b/c/c5/w;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized g(Landroid/content/Context;)Ld/j/b/c/h5/k0;
    ...
    :try_start_0
    sget-object v1, Ld/s/a/k/i/a;->e:Ld/j/b/c/h5/k0;
    ...
    sput-object v1, Ld/s/a/k/i/a;->e:Ld/j/b/c/h5/k0;

    :cond_0
    sget-object p0, Ld/s/a/k/i/a;->e:Ld/j/b/c/h5/k0;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized h(Landroid/content/Context;)Ld/j/b/c/i5/v$a;
    ...
    :try_start_0
    sget-object v1, Ld/s/a/k/i/a;->b:Ld/j/b/c/i5/v$a;
    ...
    const-string v1, "TuLatinoTvPlayer"
    ...
    sput-object v1, Ld/s/a/k/i/a;->b:Ld/j/b/c/i5/v$a;

    :cond_0
    sget-object p0, Ld/s/a/k/i/a;->b:Ld/j/b/c/i5/v$a;
    ...
    sput-object p0, Ld/s/a/k/i/a;->b:Ld/j/b/c/i5/v$a;
