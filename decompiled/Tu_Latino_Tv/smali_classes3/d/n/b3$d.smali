...
.method public constructor <init>(Lorg/json/JSONObject;Ld/n/b3$t;)V
    ...
    iput-object p1, p0, Ld/n/b3$d;->a:Lorg/json/JSONObject;

    iput-object p2, p0, Ld/n/b3$d;->c:Ld/n/b3$t;
...
.method public run()V
    ...
    iget-object v0, p0, Ld/n/b3$d;->a:Lorg/json/JSONObject;
    ...
    iget-object v0, p0, Ld/n/b3$d;->c:Ld/n/b3$t;

    if-eqz v0, :cond_0

    new-instance v2, Ld/n/b3$n0;

    const/4 v3, -0x1

    invoke-direct {v2, v3, v1}, Ld/n/b3$n0;-><init>(ILjava/lang/String;)V

    invoke-interface {v0, v2}, Ld/n/b3$t;->b(Ld/n/b3$n0;)V
    ...
    iget-object v2, p0, Ld/n/b3$d;->a:Lorg/json/JSONObject;
    ...
    :try_start_0
    iget-object v4, p0, Ld/n/b3$d;->a:Lorg/json/JSONObject;
    ...
    :cond_3
    iget-object v5, p0, Ld/n/b3$d;->a:Lorg/json/JSONObject;
    ...
    invoke-static {v4, v3}, Ld/n/b3;->a(Ld/n/b3$z;Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-interface {v0, v2}, Ld/n/p1;->debug(Ljava/lang/String;)V

    iget-object v0, p0, Ld/n/b3$d;->c:Ld/n/b3$t;

    invoke-static {v1, v0}, Ld/n/p3;->q(Lorg/json/JSONObject;Ld/n/b3$t;)V
    ...
    iget-object v1, p0, Ld/n/b3$d;->c:Ld/n/b3$t;
