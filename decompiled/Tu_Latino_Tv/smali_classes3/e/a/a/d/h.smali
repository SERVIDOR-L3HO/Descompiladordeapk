...
# direct methods
.method public static a(Landroid/content/Context;Ljava/lang/String;)Le/a/a/d/h$b;
    .locals 5

    invoke-static {p0}, Le/a/a/d/h;->b(Landroid/content/Context;)V
    ...
    new-instance v2, Le/a/a/d/h$a;

    invoke-direct {v2, v0}, Le/a/a/d/h$a;-><init>(Ljava/util/concurrent/BlockingQueue;)V
    ...
    new-instance p1, Le/a/a/d/h$b;

    invoke-interface {v0}, Ljava/util/concurrent/BlockingQueue;->take()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Le/a/a/c/c;

    invoke-direct {p1, p0, v2, v0}, Le/a/a/d/h$b;-><init>(Landroid/content/Context;Landroid/content/ServiceConnection;Le/a/a/c/c;)V
...
.method public static c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-static {p0, p1}, Le/a/a/d/h;->a(Landroid/content/Context;Ljava/lang/String;)Le/a/a/d/h$b;
    ...
    :try_start_1
    invoke-virtual {p0}, Le/a/a/d/h$b;->g()Le/a/a/c/c;

    move-result-object p1

    invoke-interface {p1, p2}, Le/a/a/c/c;->getCertificateChain(Ljava/lang/String;)[B
    ...
    :try_start_2
    invoke-virtual {p0}, Le/a/a/d/h$b;->close()V
    :try_end_2
    ...
    :cond_0
    :try_start_3
    invoke-static {p1}, Le/a/a/d/h;->e([B)Ljava/util/Collection;
...
.method public static d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[BLandroid/os/Bundle;)[B
    ...
    invoke-interface {p1, p2, p3, p4}, Le/a/a/c/c;->K6(Ljava/lang/String;[BLandroid/os/Bundle;)[B

    move-result-object p4

    if-nez p4, :cond_0

    invoke-interface {p1, p2, p3}, Le/a/a/c/c;->A2(Ljava/lang/String;[B)[B
