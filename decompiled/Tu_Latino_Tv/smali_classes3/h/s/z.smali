...
.method public static final d()Ljava/util/Map;
    ...
    sget-object v0, Lh/s/u;->a:Lh/s/u;
    ...
    invoke-static {v0, v1}, Lh/y/d/i;->d(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public static final e(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lh/s/y;->c(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final g(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lh/s/z;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lh/s/y;->b(Lh/j;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lh/s/z;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lh/s/z;->e(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lh/s/z;->f(Ljava/util/Map;Ljava/lang/Iterable;)V
