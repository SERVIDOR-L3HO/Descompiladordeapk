...
.method public a(Ld/n/i0$f;)V
    ...
    invoke-direct {v0, p1}, Ld/n/q1;-><init>(Lorg/json/JSONObject;)V

    new-instance v1, Ld/n/v1;

    iget-object v2, p0, Lcom/onesignal/ADMMessageHandlerJob$a;->b:Landroid/content/Context;

    invoke-direct {v1, v2}, Ld/n/v1;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1, p1}, Ld/n/v1;->q(Lorg/json/JSONObject;)V

    iget-object p1, p0, Lcom/onesignal/ADMMessageHandlerJob$a;->b:Landroid/content/Context;

    invoke-virtual {v1, p1}, Ld/n/v1;->o(Landroid/content/Context;)V

    invoke-virtual {v1, v0}, Ld/n/v1;->r(Ld/n/q1;)V

    const/4 p1, 0x1

    invoke-static {v1, p1}, Ld/n/i0;->m(Ld/n/v1;Z)I
