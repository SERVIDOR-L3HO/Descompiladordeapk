...
.method public static g(Landroid/content/Context;Landroid/content/Intent;Landroid/os/Bundle;Ld/n/i0$e;)V
    .locals 0
    ...
    invoke-interface {p3, p1}, Ld/n/i0$e;->a(Ld/n/i0$f;)V

    :cond_0
    new-instance p1, Lcom/onesignal/FCMBroadcastReceiver$b;

    invoke-direct {p1, p3, p0, p2}, Lcom/onesignal/FCMBroadcastReceiver$b;-><init>(Ld/n/i0$e;Landroid/content/Context;Landroid/os/Bundle;)V

    invoke-static {p0, p2, p1}, Ld/n/i0;->h(Landroid/content/Context;Landroid/os/Bundle;Ld/n/i0$e;)V

    return-void
.end method

.method public static i(Landroid/os/Bundle;Ld/n/k;)Ld/n/k;
    .locals 4

    invoke-static {p0}, Ld/n/i0;->a(Landroid/os/Bundle;)Lorg/json/JSONObject;
    ...
    invoke-interface {p1, v0, p0}, Ld/n/k;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p1, v0, p0}, Ld/n/k;->e(Ljava/lang/String;Ljava/lang/Long;)V
...
.method public static k(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Ld/n/i0;->c(Landroid/os/Bundle;)Z
    ...
    invoke-static {}, Ld/n/m;->a()Ld/n/k;

    move-result-object v0

    invoke-static {p1, v0}, Lcom/onesignal/FCMBroadcastReceiver;->i(Landroid/os/Bundle;Ld/n/k;)Ld/n/k;

    move-result-object p1

    invoke-static {p0, p1}, Ld/n/i0;->j(Landroid/content/Context;Ld/n/k;)V
...
.method public static l(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-interface {p1}, Ld/n/k;->f()Ljava/lang/Object;
...
.method public static m(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    new-instance v1, Ld/n/l;

    invoke-direct {v1}, Ld/n/l;-><init>()V

    invoke-static {p1, v1}, Lcom/onesignal/FCMBroadcastReceiver;->i(Landroid/os/Bundle;Ld/n/k;)Ld/n/k;
    ...
    invoke-static {p0, p1}, Lb/p/a/a;->c(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :cond_0
    invoke-static {p1}, Ld/n/b3;->L0(Landroid/content/Context;)V
    ...
    invoke-static {p1, p2, v0, v1}, Lcom/onesignal/FCMBroadcastReceiver;->g(Landroid/content/Context;Landroid/content/Intent;Landroid/os/Bundle;Ld/n/i0$e;)V
