...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Ld/j/d/v/g;-><init>()V
...
.method public c(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {p1}, Ld/j/d/r/x;->c()Landroid/content/Intent;
...
.method public d(Landroid/content/Intent;)V
    ...
    invoke-static {p1}, Ld/j/d/v/u;->B(Landroid/content/Intent;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p1}, Ld/j/d/v/u;->t(Landroid/content/Intent;)V
...
.method public final k(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Ld/j/d/v/v;->t(Landroid/os/Bundle;)Z

    move-result v1

    if-eqz v1, :cond_2

    new-instance v1, Ld/j/d/v/v;

    invoke-direct {v1, v0}, Ld/j/d/v/v;-><init>(Landroid/os/Bundle;)V

    invoke-static {}, Ld/j/d/v/h;->d()Ljava/util/concurrent/ExecutorService;

    move-result-object v2

    new-instance v3, Ld/j/d/v/c;

    invoke-direct {v3, p0, v1, v2}, Ld/j/d/v/c;-><init>(Landroid/content/Context;Ld/j/d/v/v;Ljava/util/concurrent/Executor;)V

    :try_start_0
    invoke-virtual {v3}, Ld/j/d/v/c;->a()Z
    ...
    invoke-static {p1}, Ld/j/d/v/u;->u(Landroid/content/Intent;)V
    ...
    :cond_2
    :goto_0
    new-instance p1, Ld/j/d/v/w;

    invoke-direct {p1, v0}, Ld/j/d/v/w;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->p(Ld/j/d/v/w;)V
...
.method public final n(Landroid/content/Intent;)V
    ...
    invoke-static {p1}, Ld/j/d/v/u;->v(Landroid/content/Intent;)V
...
.method public final t(Landroid/content/Intent;)V
    ...
    invoke-direct {v1, p1}, Ld/j/d/v/y;-><init>(Ljava/lang/String;)V
    ...
    :cond_6
    invoke-static {p1}, Ld/j/d/v/u;->w(Landroid/content/Intent;)V
