...
.method public J(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-static {v0, v13}, Ld/j/b/f/m/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
...
.method public final K(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    :cond_0
    instance-of v0, p1, Ld/j/b/f/q0/b;

    if-nez v0, :cond_2

    instance-of v0, p1, Ld/j/b/f/q0/a;
...
.method public final L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ld/j/b/f/m/i;Ld/j/b/f/m/i;FFFFLandroid/graphics/RectF;)V
    .locals 0

    invoke-virtual {p0, p2, p3, p5, p7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ld/j/b/f/m/i;FF)F

    move-result p3

    invoke-virtual {p0, p2, p4, p6, p8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ld/j/b/f/m/i;FF)F
...
.method public final N(FFZLcom/google/android/material/transformation/FabTransformationBehavior$e;)Landroid/util/Pair;
    ...
    :cond_2
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ld/j/b/f/m/h;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, Ld/j/b/f/m/h;->e(Ljava/lang/String;)Ld/j/b/f/m/i;

    move-result-object p1

    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ld/j/b/f/m/h;
    ...
    :goto_1
    invoke-virtual {p2, p3}, Ld/j/b/f/m/h;->e(Ljava/lang/String;)Ld/j/b/f/m/i;
...
.method public final O(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F
    .locals 2
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F
...
.method public final P(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F
    .locals 2
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F
...
.method public final Q(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F
    .locals 2
...
.method public final R(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F
    .locals 2
...
.method public final S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ld/j/b/f/m/i;FF)F
    .locals 8

    invoke-virtual {p2}, Ld/j/b/f/m/i;->c()J

    move-result-wide v0

    invoke-virtual {p2}, Ld/j/b/f/m/i;->d()J

    move-result-wide v2

    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ld/j/b/f/m/h;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Ld/j/b/f/m/h;->e(Ljava/lang/String;)Ld/j/b/f/m/i;

    move-result-object p1

    invoke-virtual {p1}, Ld/j/b/f/m/i;->c()J

    move-result-wide v4

    invoke-virtual {p1}, Ld/j/b/f/m/i;->d()J
    ...
    invoke-virtual {p2}, Ld/j/b/f/m/i;->e()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p1}, Ld/j/b/f/m/a;->a(FFF)F
...
.method public final U(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_0
    instance-of p1, p2, Ld/j/b/f/v/d;

    if-eqz p1, :cond_1

    sget p1, Ld/j/b/f/v/c;->a:I
    ...
    sget-object p3, Ld/j/b/f/m/d;->a:Landroid/util/Property;
    ...
    :cond_3
    sget-object p2, Ld/j/b/f/m/d;->a:Landroid/util/Property;
    ...
    :goto_0
    iget-object p2, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ld/j/b/f/m/h;
    ...
    invoke-virtual {p2, p1}, Ld/j/b/f/m/i;->a(Landroid/animation/Animator;)V
...
.method public final V(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    instance-of p7, p2, Ld/j/b/f/v/d;
    ...
    invoke-interface {p2, p1}, Ld/j/b/f/v/d;->setCircularRevealScrimColor(I)V

    :cond_1
    sget-object p1, Ld/j/b/f/v/d$d;->a:Landroid/util/Property;
    ...
    :cond_2
    sget-object p3, Ld/j/b/f/v/d$d;->a:Landroid/util/Property;
    ...
    :goto_0
    invoke-static {}, Ld/j/b/f/m/c;->b()Ld/j/b/f/m/c;
...
.method public final W(Landroid/view/View;Landroid/view/View;ZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;)V
    ...
    iget-object v0, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/j/b/f/m/j;

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F

    move-result v0

    iget-object v1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/j/b/f/m/j;

    invoke-virtual {p0, p1, p2, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F
    ...
    check-cast v1, Ld/j/b/f/m/i;

    iget-object p4, p4, Landroid/util/Pair;->second:Ljava/lang/Object;

    check-cast p4, Ld/j/b/f/m/i;
    ...
    invoke-virtual {v1, v0}, Ld/j/b/f/m/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {p4, p1}, Ld/j/b/f/m/i;->a(Landroid/animation/Animator;)V
...
.method public final X(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static {p2}, Lb/j/s/x;->w(Landroid/view/View;)F

    move-result p7

    invoke-static {p1}, Lb/j/s/x;->w(Landroid/view/View;)F
...
.method public final Y(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;FFLjava/util/List;Ljava/util/List;)V
    ...
    instance-of v1, v8, Ld/j/b/f/v/d;
    ...
    check-cast v13, Ld/j/b/f/v/d;

    iget-object v1, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/j/b/f/m/j;

    invoke-virtual {v12, v0, v8, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->O(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F

    move-result v1

    iget-object v2, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/j/b/f/m/j;

    invoke-virtual {v12, v0, v8, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->P(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F
    ...
    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ld/j/b/f/m/h;

    const-string v2, "expansion"

    invoke-virtual {v0, v2}, Ld/j/b/f/m/h;->e(Ljava/lang/String;)Ld/j/b/f/m/i;
    ...
    invoke-direct {v0, v1, v10, v11}, Ld/j/b/f/v/d$e;-><init>(FFF)V

    invoke-interface {v13, v0}, Ld/j/b/f/v/d;->setRevealInfo(Ld/j/b/f/v/d$e;)V

    :cond_1
    if-eqz p4, :cond_2

    invoke-interface {v13}, Ld/j/b/f/v/d;->getRevealInfo()Ld/j/b/f/v/d$e;

    move-result-object v0

    iget v0, v0, Ld/j/b/f/v/d$e;->c:F
    ...
    invoke-static/range {v2 .. v7}, Ld/j/b/f/e0/a;->b(FFFFFF)F

    move-result v0

    invoke-static {v13, v1, v10, v0}, Ld/j/b/f/v/a;->a(Ld/j/b/f/v/d;FFF)Landroid/animation/Animator;

    move-result-object v9

    new-instance v0, Lcom/google/android/material/transformation/FabTransformationBehavior$d;

    invoke-direct {v0, v12, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior$d;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Ld/j/b/f/v/d;)V

    invoke-virtual {v9, v0}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {v14}, Ld/j/b/f/m/i;->c()J
    ...
    iget v6, v0, Ld/j/b/f/v/d$e;->c:F

    invoke-static {v13, v1, v10, v11}, Ld/j/b/f/v/a;->a(Ld/j/b/f/v/d;FFF)Landroid/animation/Animator;
    ...
    invoke-virtual {v14}, Ld/j/b/f/m/i;->d()J

    move-result-wide v4

    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ld/j/b/f/m/h;

    invoke-virtual {v0}, Ld/j/b/f/m/h;->f()J
    ...
    :goto_0
    invoke-virtual {v14, v9}, Ld/j/b/f/m/i;->a(Landroid/animation/Animator;)V

    move-object/from16 v0, p8

    invoke-interface {v0, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v13}, Ld/j/b/f/v/a;->b(Ld/j/b/f/v/d;)Landroid/animation/Animator$AnimatorListener;
...
.method public final Z(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    instance-of v0, p2, Ld/j/b/f/v/d;
    ...
    :cond_2
    sget-object p3, Ld/j/b/f/m/e;->a:Landroid/util/Property;
    ...
    invoke-virtual {p2, p4}, Ld/j/b/f/m/h;->e(Ljava/lang/String;)Ld/j/b/f/m/i;

    move-result-object p2

    invoke-virtual {p2, p3}, Ld/j/b/f/m/i;->a(Landroid/animation/Animator;)V

    invoke-interface {p6, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p2, Lcom/google/android/material/transformation/FabTransformationBehavior$c;

    invoke-direct {p2, p0, v0, p1}, Lcom/google/android/material/transformation/FabTransformationBehavior$c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Ld/j/b/f/v/d;Landroid/graphics/drawable/Drawable;)V
...
.method public final c0(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    iget-object v4, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/j/b/f/m/j;

    invoke-virtual {v10, v0, v1, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F

    move-result v4

    iget-object v5, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/j/b/f/m/j;

    invoke-virtual {v10, v0, v1, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ld/j/b/f/m/j;)F
    ...
    check-cast v12, Ld/j/b/f/m/i;

    iget-object v5, v5, Landroid/util/Pair;->second:Ljava/lang/Object;

    move-object v13, v5

    check-cast v13, Ld/j/b/f/m/i;
    ...
    invoke-virtual/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ld/j/b/f/m/i;Ld/j/b/f/m/i;FFFFLandroid/graphics/RectF;)V
    ...
    :goto_0
    invoke-virtual {v12, v14}, Ld/j/b/f/m/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {v13, v15}, Ld/j/b/f/m/i;->a(Landroid/animation/Animator;)V
...
.method public final d0(Landroid/view/View;)I
    ...
    invoke-static {p1}, Lb/j/s/x;->s(Landroid/view/View;)Landroid/content/res/ColorStateList;
