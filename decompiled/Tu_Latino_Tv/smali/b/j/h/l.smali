...
.field public final c:Lb/j/h/k$e;
...
# direct methods
.method public constructor <init>(Lb/j/h/k$e;)V
    .locals 13
    ...
    iput-object v0, p0, Lb/j/h/l;->f:Ljava/util/List;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, Lb/j/h/l;->g:Landroid/os/Bundle;

    iput-object p1, p0, Lb/j/h/l;->c:Lb/j/h/k$e;

    iget-object v0, p1, Lb/j/h/k$e;->a:Landroid/content/Context;

    iput-object v0, p0, Lb/j/h/l;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, Lb/j/h/k$e;->a:Landroid/content/Context;

    if-lt v0, v1, :cond_0

    iget-object v4, p1, Lb/j/h/k$e;->L:Ljava/lang/String;
    ...
    :goto_0
    iput-object v2, p0, Lb/j/h/l;->b:Landroid/app/Notification$Builder;

    iget-object v2, p1, Lb/j/h/k$e;->T:Landroid/app/Notification;

    iget-object v3, p0, Lb/j/h/l;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Lb/j/h/k$e;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Lb/j/h/k$e;->e:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lb/j/h/k$e;->f:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lb/j/h/k$e;->k:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lb/j/h/k$e;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lb/j/h/k$e;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lb/j/h/k$e;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Lb/j/h/k$e;->l:I

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v4, p1, Lb/j/h/k$e;->u:I

    iget v9, p1, Lb/j/h/k$e;->v:I

    iget-boolean v10, p1, Lb/j/h/k$e;->w:Z
    ...
    iget-object v4, p0, Lb/j/h/l;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Lb/j/h/l;->b:Landroid/app/Notification$Builder;

    iget-object v8, p1, Lb/j/h/k$e;->r:Ljava/lang/CharSequence;
    ...
    check-cast v8, Lb/j/h/k$a;

    invoke-virtual {p0, v8}, Lb/j/h/l;->b(Lb/j/h/k$a;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, Lb/j/h/k$e;->E:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    iget-object v8, p0, Lb/j/h/l;->g:Landroid/os/Bundle;
    ...
    iget-boolean v0, p1, Lb/j/h/k$e;->A:Z

    if-eqz v0, :cond_8

    iget-object v0, p0, Lb/j/h/l;->g:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v0, p1, Lb/j/h/k$e;->x:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Lb/j/h/k$e;->y:Z
    ...
    :cond_a
    iget-object v0, p1, Lb/j/h/k$e;->z:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p1, Lb/j/h/k$e;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lb/j/h/l;->d:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lb/j/h/k$e;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lb/j/h/l;->e:Landroid/widget/RemoteViews;
    ...
    iget-object v8, p0, Lb/j/h/l;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Lb/j/h/k$e;->n:Z
    ...
    iget-object v8, p1, Lb/j/h/k$e;->c:Ljava/util/ArrayList;

    invoke-static {v8}, Lb/j/h/l;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Lb/j/h/k$e;->W:Ljava/util/ArrayList;

    invoke-static {v8, v9}, Lb/j/h/l;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v9, p0, Lb/j/h/l;->g:Landroid/os/Bundle;
    ...
    iget-object v0, p1, Lb/j/h/k$e;->c:Ljava/util/ArrayList;

    invoke-static {v0}, Lb/j/h/l;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, Lb/j/h/k$e;->W:Ljava/util/ArrayList;

    invoke-static {v0, v3}, Lb/j/h/l;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    :cond_10
    iget-object v0, p1, Lb/j/h/k$e;->W:Ljava/util/ArrayList;
    ...
    :cond_11
    iget-object v0, p1, Lb/j/h/k$e;->K:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lb/j/h/l;->i:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lb/j/h/k$e;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Lb/j/h/k$e;->f()Landroid/os/Bundle;
    ...
    :goto_9
    iget-object v11, p1, Lb/j/h/k$e;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Lb/j/h/k$e;->d:Ljava/util/ArrayList;

    invoke-virtual {v12, v10}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Lb/j/h/k$a;

    invoke-static {v12}, Lb/j/h/m;->b(Lb/j/h/k$a;)Landroid/os/Bundle;
    ...
    iget-object v3, p1, Lb/j/h/k$e;->V:Landroid/graphics/drawable/Icon;
    ...
    iget-object v3, p1, Lb/j/h/k$e;->I:Landroid/widget/RemoteViews;
    ...
    :cond_16
    iget-object v3, p1, Lb/j/h/k$e;->J:Landroid/widget/RemoteViews;
    ...
    :cond_17
    iget-object v3, p1, Lb/j/h/k$e;->K:Landroid/widget/RemoteViews;
    ...
    check-cast v4, Lb/j/h/o;

    iget-object v7, p0, Lb/j/h/l;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Lb/j/h/o;->h()Landroid/app/Person;
    ...
    iget-boolean v7, p1, Lb/j/h/k$e;->R:Z
    ...
    iget-object v7, p1, Lb/j/h/k$e;->S:Lb/j/h/k$d;

    invoke-static {v7}, Lb/j/h/k$d;->a(Lb/j/h/k$d;)Landroid/app/Notification$BubbleMetadata;
    ...
    iget-object v4, p1, Lb/j/h/k$e;->O:Lb/j/i/c;
    ...
    :cond_1d
    :goto_b
    iget-boolean p1, p1, Lb/j/h/k$e;->U:Z

    if-eqz p1, :cond_20

    iget-object p1, p0, Lb/j/h/l;->c:Lb/j/h/k$e;

    iget-boolean p1, p1, Lb/j/h/k$e;->y:Z

    if-eqz p1, :cond_1e

    iput v5, p0, Lb/j/h/l;->h:I

    goto :goto_c

    :cond_1e
    iput v6, p0, Lb/j/h/l;->h:I

    :goto_c
    iget-object p1, p0, Lb/j/h/l;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p0, Lb/j/h/l;->b:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Lb/j/h/k$e;->x:Ljava/lang/String;
...
.method public static e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v0, v1}, Lb/f/b;-><init>(I)V

    invoke-virtual {v0, p0}, Lb/f/b;->addAll(Ljava/util/Collection;)Z
...
.method public static g(Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v1, Lb/j/h/o;

    invoke-virtual {v1}, Lb/j/h/o;->g()Ljava/lang/String;
...
.method public final b(Lb/j/h/k$a;)V
    .locals 5
    ...
    invoke-virtual {p1}, Lb/j/h/k$a;->f()Landroidx/core/graphics/drawable/IconCompat;
    ...
    :goto_2
    invoke-virtual {p1}, Lb/j/h/k$a;->g()[Lb/j/h/p;
    ...
    invoke-static {v1}, Lb/j/h/p;->b([Lb/j/h/p;)[Landroid/app/RemoteInput;
    ...
    :cond_3
    invoke-virtual {p1}, Lb/j/h/k$a;->d()Landroid/os/Bundle;
    ...
    :goto_4
    invoke-virtual {p1}, Lb/j/h/k$a;->b()Z
    ...
    :cond_5
    invoke-virtual {p1}, Lb/j/h/k$a;->h()I
    ...
    invoke-virtual {p1}, Lb/j/h/k$a;->k()Z
    ...
    :cond_7
    invoke-virtual {p1}, Lb/j/h/k$a;->i()Z
    ...
    iget-object v0, p0, Lb/j/h/l;->f:Ljava/util/List;

    iget-object v1, p0, Lb/j/h/l;->b:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Lb/j/h/m;->f(Landroid/app/Notification$Builder;Lb/j/h/k$a;)Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    iget-object v0, p0, Lb/j/h/l;->c:Lb/j/h/k$e;

    iget-object v0, v0, Lb/j/h/k$e;->q:Lb/j/h/k$h;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Lb/j/h/k$h;->b(Lb/j/h/j;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Lb/j/h/k$h;->j(Lb/j/h/j;)Landroid/widget/RemoteViews;
    ...
    :goto_0
    invoke-virtual {p0}, Lb/j/h/l;->d()Landroid/app/Notification;
    ...
    :cond_2
    iget-object v1, p0, Lb/j/h/l;->c:Lb/j/h/k$e;

    iget-object v1, v1, Lb/j/h/k$e;->I:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Lb/j/h/k$h;->i(Lb/j/h/j;)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, Lb/j/h/l;->c:Lb/j/h/k$e;

    iget-object v4, v4, Lb/j/h/k$e;->q:Lb/j/h/k$h;

    invoke-virtual {v4, p0}, Lb/j/h/k$h;->k(Lb/j/h/j;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, Lb/j/h/k;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-virtual {v0, v1}, Lb/j/h/k$h;->a(Landroid/os/Bundle;)V
...
.method public d()Landroid/app/Notification;
    ...
    invoke-virtual {p0, v0}, Lb/j/h/l;->h(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Lb/j/h/l;->g:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lb/j/h/l;->d:Landroid/widget/RemoteViews;
    ...
    :cond_4
    iget-object v1, p0, Lb/j/h/l;->e:Landroid/widget/RemoteViews;
    ...
    :cond_5
    iget-object v1, p0, Lb/j/h/l;->i:Landroid/widget/RemoteViews;
    ...
    invoke-static {v0}, Lb/j/h/m;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    invoke-static {v0}, Lb/j/h/k;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    new-instance v3, Landroid/os/Bundle;

    iget-object v4, p0, Lb/j/h/l;->g:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lb/j/h/l;->f:Ljava/util/List;

    invoke-static {v1}, Lb/j/h/m;->a(Ljava/util/List;)Landroid/util/SparseArray;
...
.method public f()Landroid/content/Context;
    ...
    iget-object v0, p0, Lb/j/h/l;->a:Landroid/content/Context;
