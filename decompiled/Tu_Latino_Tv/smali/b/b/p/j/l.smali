...
.method public final a()Lb/b/p/j/k;
    ...
    invoke-virtual {v0, v1}, Lb/b/p/j/k;->j(Lb/b/p/j/g;)V

    iget-object v1, p0, Lb/b/p/j/l;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Lb/b/p/j/k;->t(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Lb/b/p/j/l;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Lb/b/p/j/k;->n(Landroid/view/View;)V

    iget-object v1, p0, Lb/b/p/j/l;->i:Lb/b/p/j/m$a;

    invoke-interface {v0, v1}, Lb/b/p/j/m;->d(Lb/b/p/j/m$a;)V

    iget-boolean v1, p0, Lb/b/p/j/l;->h:Z

    invoke-virtual {v0, v1}, Lb/b/p/j/k;->q(Z)V

    iget v1, p0, Lb/b/p/j/l;->g:I

    invoke-virtual {v0, v1}, Lb/b/p/j/k;->r(I)V
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, Lb/b/p/j/k;->q(Z)V
...
.method public j(Lb/b/p/j/m$a;)V
    .locals 1
    ...
    invoke-interface {v0, p1}, Lb/b/p/j/m;->d(Lb/b/p/j/m$a;)V
...
.method public k()V
    ...
    invoke-virtual {p0}, Lb/b/p/j/l;->m()Z
...
.method public final l(IIZZ)V
    ...
    invoke-virtual {v0, p4}, Lb/b/p/j/k;->u(Z)V
    ...
    invoke-static {p4}, Lb/j/s/x;->C(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, Lb/j/s/f;->b(II)I
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lb/b/p/j/k;->s(I)V

    invoke-virtual {v0, p2}, Lb/b/p/j/k;->v(I)V
    ...
    invoke-virtual {v0, p4}, Lb/b/p/j/k;->p(Landroid/graphics/Rect;)V
...
.method public m()Z
    ...
    :cond_1
    invoke-virtual {p0, v2, v2, v2, v2}, Lb/b/p/j/l;->l(IIZZ)V
...
.method public n(II)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, v1, v1}, Lb/b/p/j/l;->l(IIZZ)V
