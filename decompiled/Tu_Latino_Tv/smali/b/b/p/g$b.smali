...
.method public g(Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Lb/b/j;->G1:[I

    invoke-static {v0, p1, v1}, Lb/b/q/u0;->u(Landroid/content/Context;Landroid/util/AttributeSet;[I)Lb/b/q/u0;
    ...
    invoke-virtual {p1, v0, v1}, Lb/b/q/u0;->n(II)I
    ...
    invoke-virtual {p1, v0, v2}, Lb/b/q/u0;->k(II)I
    ...
    invoke-virtual {p1, v2, v3}, Lb/b/q/u0;->k(II)I
    ...
    invoke-virtual {p1, v0}, Lb/b/q/u0;->p(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v0}, Lb/b/q/u0;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Lb/b/q/u0;->s(I)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {p1, v0, v1}, Lb/b/q/u0;->a(IZ)Z
    ...
    invoke-virtual {p1, v0, v2}, Lb/b/q/u0;->a(IZ)Z
    ...
    check-cast v0, Lb/j/s/b;

    iput-object v0, p0, Lb/b/p/g$b;->A:Lb/j/s/b;
    ...
    :cond_3
    iput-object v4, p0, Lb/b/p/g$b;->A:Lb/j/s/b;
    ...
    invoke-virtual {p1, v0}, Lb/b/q/u0;->c(I)Landroid/content/res/ColorStateList;
...
.method public final i(Landroid/view/MenuItem;)V
    ...
    :cond_8
    :goto_3
    iget-object v0, p0, Lb/b/p/g$b;->A:Lb/j/s/b;

    if-eqz v0, :cond_9

    invoke-static {p1, v0}, Lb/j/s/j;->c(Landroid/view/MenuItem;Lb/j/s/b;)Landroid/view/MenuItem;

    :cond_9
    iget-object v0, p0, Lb/b/p/g$b;->B:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Lb/j/s/j;->e(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lb/b/p/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Lb/j/s/j;->i(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Lb/b/p/g$b;->n:C

    iget v1, p0, Lb/b/p/g$b;->o:I

    invoke-static {p1, v0, v1}, Lb/j/s/j;->d(Landroid/view/MenuItem;CI)V

    iget-char v0, p0, Lb/b/p/g$b;->p:C

    iget v1, p0, Lb/b/p/g$b;->q:I

    invoke-static {p1, v0, v1}, Lb/j/s/j;->h(Landroid/view/MenuItem;CI)V

    iget-object v0, p0, Lb/b/p/g$b;->E:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_a

    invoke-static {p1, v0}, Lb/j/s/j;->g(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Lb/j/s/j;->f(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
