...
.field private mRemoteUserInfo:Lb/t/b;
...
.field private mVolumeCallback:Lb/t/i$d;

.field public mVolumeProvider:Lb/t/i;

.field public mVolumeType:I


# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Lb/h0/d;Landroid/os/Bundle;)V
    .locals 3
    ...
    iput-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Lb/t/i$d;
    ...
    invoke-direct {p2, p1, p3, p5}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lb/h0/d;)V
...
.method public adjustVolume(II)V
    ...
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lb/t/i;

    if-eqz p2, :cond_1

    invoke-virtual {p2, p1}, Lb/t/i;->e(I)V
...
.method public getCurrentControllerInfo()Lb/t/b;
    .locals 2
    ...
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lb/t/b;
...
.method public setCurrentControllerInfo(Lb/t/b;)V
    .locals 1
    ...
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lb/t/b;
...
.method public setPlaybackToLocal(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lb/t/i;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lb/t/i;->g(Lb/t/i$d;)V
...
.method public setPlaybackToRemote(Lb/t/i;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lb/t/i;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lb/t/i;

    invoke-virtual {v1}, Lb/t/i;->c()I

    move-result v4

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lb/t/i;

    invoke-virtual {v1}, Lb/t/i;->b()I

    move-result v5

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lb/t/i;

    invoke-virtual {v1}, Lb/t/i;->a()I
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Lb/t/i$d;

    invoke-virtual {p1, v0}, Lb/t/i;->g(Lb/t/i$d;)V
...
.method public setVolumeTo(II)V
    ...
    invoke-virtual {p2, p1}, Lb/t/i;->f(I)V
