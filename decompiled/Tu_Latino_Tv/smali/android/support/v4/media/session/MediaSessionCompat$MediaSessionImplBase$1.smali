...
.method public constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;)V
    ...
    invoke-direct {p0}, Lb/t/i$d;-><init>()V
...
# virtual methods
.method public onVolumeChanged(Lb/t/i;)V
    .locals 7
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lb/t/i;
    ...
    invoke-virtual {p1}, Lb/t/i;->c()I

    move-result v4

    invoke-virtual {p1}, Lb/t/i;->b()I

    move-result v5

    invoke-virtual {p1}, Lb/t/i;->a()I
