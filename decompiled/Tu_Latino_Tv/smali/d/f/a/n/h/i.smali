...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ld/f/a/n/h/i;->d:Landroid/content/UriMatcher;
...
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1, p2}, Ld/f/a/n/h/g;-><init>(Landroid/content/Context;Landroid/net/Uri;)V
...
.method public bridge synthetic c(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Ld/f/a/n/h/i;->e(Ljava/io/InputStream;)V
...
.method public bridge synthetic d(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Ld/f/a/n/h/i;->f(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
...
.method public f(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
    ...
    sget-object v0, Ld/f/a/n/h/i;->d:Landroid/content/UriMatcher;

    invoke-virtual {v0, p1}, Landroid/content/UriMatcher;->match(Landroid/net/Uri;)I

    move-result v0

    invoke-virtual {p0, p1, p2, v0}, Ld/f/a/n/h/i;->g(Landroid/net/Uri;Landroid/content/ContentResolver;I)Ljava/io/InputStream;
...
.method public final g(Landroid/net/Uri;Landroid/content/ContentResolver;I)Ljava/io/InputStream;
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, p2, p1}, Ld/f/a/n/h/i;->h(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/io/InputStream;
