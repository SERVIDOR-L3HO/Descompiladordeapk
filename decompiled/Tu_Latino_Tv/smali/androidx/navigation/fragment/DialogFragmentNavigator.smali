...
.field public e:Lb/q/j;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lb/m/d/n;)V
    .locals 1
    ...
    iput-object v0, p0, Landroidx/navigation/fragment/DialogFragmentNavigator;->e:Lb/q/j;

    iput-object p1, p0, Landroidx/navigation/fragment/DialogFragmentNavigator;->a:Landroid/content/Context;

    iput-object p2, p0, Landroidx/navigation/fragment/DialogFragmentNavigator;->b:Lb/m/d/n;
...
.method public bridge synthetic b(Lb/w/k;Landroid/os/Bundle;Lb/w/p;Lb/w/s$a;)Lb/w/k;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Landroidx/navigation/fragment/DialogFragmentNavigator;->g(Landroidx/navigation/fragment/DialogFragmentNavigator$a;Landroid/os/Bundle;Lb/w/p;Lb/w/s$a;)Lb/w/k;
...
.method public c(Landroid/os/Bundle;)V
    ...
    iget-object p1, p0, Landroidx/navigation/fragment/DialogFragmentNavigator;->b:Lb/m/d/n;
    ...
    check-cast p1, Lb/m/d/d;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Landroidx/fragment/app/Fragment;->getLifecycle()Lb/q/f;

    move-result-object p1

    iget-object v0, p0, Landroidx/navigation/fragment/DialogFragmentNavigator;->e:Lb/q/j;
...
.method public e()Z
    ...
    :cond_0
    iget-object v0, p0, Landroidx/navigation/fragment/DialogFragmentNavigator;->b:Lb/m/d/n;
    ...
    invoke-virtual {v0, v1}, Lb/m/d/n;->i0(Ljava/lang/String;)Landroidx/fragment/app/Fragment;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Landroidx/fragment/app/Fragment;->getLifecycle()Lb/q/f;

    move-result-object v1

    iget-object v2, p0, Landroidx/navigation/fragment/DialogFragmentNavigator;->e:Lb/q/j;

    invoke-virtual {v1, v2}, Lb/q/f;->c(Lb/q/k;)V
...
.method public f()Landroidx/navigation/fragment/DialogFragmentNavigator$a;
    ...
    invoke-direct {v0, p0}, Landroidx/navigation/fragment/DialogFragmentNavigator$a;-><init>(Lb/w/s;)V

    return-object v0
.end method

.method public g(Landroidx/navigation/fragment/DialogFragmentNavigator$a;Landroid/os/Bundle;Lb/w/p;Lb/w/s$a;)Lb/w/k;
    .locals 2

    iget-object p3, p0, Landroidx/navigation/fragment/DialogFragmentNavigator;->b:Lb/m/d/n;

    invoke-virtual {p3}, Lb/m/d/n;->L0()Z
    ...
    :cond_0
    invoke-virtual {p1}, Landroidx/navigation/fragment/DialogFragmentNavigator$a;->M()Ljava/lang/String;
    ...
    :cond_1
    iget-object p4, p0, Landroidx/navigation/fragment/DialogFragmentNavigator;->b:Lb/m/d/n;

    invoke-virtual {p4}, Lb/m/d/n;->r0()Lb/m/d/j;
    ...
    invoke-virtual {p4, v0, p3}, Lb/m/d/j;->a(Ljava/lang/ClassLoader;Ljava/lang/String;)Landroidx/fragment/app/Fragment;

    move-result-object p3

    const-class p4, Lb/m/d/d;
    ...
    check-cast p3, Lb/m/d/d;

    invoke-virtual {p3, p2}, Landroidx/fragment/app/Fragment;->setArguments(Landroid/os/Bundle;)V

    invoke-virtual {p3}, Landroidx/fragment/app/Fragment;->getLifecycle()Lb/q/f;

    move-result-object p2

    iget-object p4, p0, Landroidx/navigation/fragment/DialogFragmentNavigator;->e:Lb/q/j;

    invoke-virtual {p2, p4}, Lb/q/f;->a(Lb/q/k;)V

    iget-object p2, p0, Landroidx/navigation/fragment/DialogFragmentNavigator;->b:Lb/m/d/n;
    ...
    invoke-virtual {p3, p2, p4}, Lb/m/d/d;->H(Lb/m/d/n;Ljava/lang/String;)V
