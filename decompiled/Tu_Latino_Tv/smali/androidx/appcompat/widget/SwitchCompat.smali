...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v2}, Lb/b/q/p0;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    sget-object v7, Lb/b/j;->Q2:[I

    invoke-static {p1, p2, v7, p3, v1}, Lb/b/q/u0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lb/b/q/u0;

    move-result-object v2

    invoke-virtual {v2}, Lb/b/q/u0;->r()Landroid/content/res/TypedArray;
    ...
    invoke-static/range {v5 .. v11}, Lb/j/s/x;->n0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    sget v4, Lb/b/j;->T2:I

    invoke-virtual {v2, v4}, Lb/b/q/u0;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v2, v4}, Lb/b/q/u0;->p(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2, v4, v3}, Lb/b/q/u0;->a(IZ)Z
    ...
    invoke-virtual {v2, v4, v1}, Lb/b/q/u0;->f(II)I
    ...
    invoke-virtual {v2, v4, v1}, Lb/b/q/u0;->a(IZ)Z
    ...
    invoke-virtual {v2, v4}, Lb/b/q/u0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v2, v4, v5}, Lb/b/q/u0;->k(II)I

    move-result v4

    invoke-static {v4, v0}, Lb/b/q/b0;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v2, v0, v1}, Lb/b/q/u0;->n(II)I
    ...
    :cond_a
    new-instance v0, Lb/b/q/w;

    invoke-direct {v0, p0}, Lb/b/q/w;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->O:Lb/b/q/w;

    invoke-virtual {v0, p2, p3}, Lb/b/q/w;->m(Landroid/util/AttributeSet;I)V

    invoke-virtual {v2}, Lb/b/q/u0;->w()V
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Lb/b/q/b0;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Lb/b/q/b0;->c:Landroid/graphics/Rect;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Lb/b/q/b0;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v6, Lb/b/q/b0;->c:Landroid/graphics/Rect;
    ...
    invoke-static {v0, v1, v2, v5, v4}, Lb/j/j/m/a;->l(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public final i()V
    ...
    :cond_0
    invoke-static {p0, v0}, Lb/j/s/x;->E0(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public k(Landroid/content/Context;I)V
    ...
    invoke-virtual {p1, p2}, Lb/b/q/u0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, p2, v0}, Lb/b/q/u0;->f(II)I
    ...
    invoke-virtual {p1, p2, v1}, Lb/b/q/u0;->k(II)I

    move-result p2

    sget v2, Lb/b/j;->i3:I

    invoke-virtual {p1, v2, v1}, Lb/b/q/u0;->k(II)I
    ...
    invoke-virtual {p1, p2, v0}, Lb/b/q/u0;->a(IZ)Z

    move-result p2

    if-eqz p2, :cond_2

    new-instance p2, Lb/b/o/a;

    invoke-virtual {p0}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-direct {p2, v0}, Lb/b/o/a;-><init>(Landroid/content/Context;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Lb/b/q/b0;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p3}, Lb/b/q/b0;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
