...
.method public M(Lb/j/s/g0/c;)V
    ...
    invoke-virtual {p1, v0}, Lb/j/s/g0/c;->V(Z)V
    ...
    :goto_0
    invoke-virtual {p1, v0}, Lb/j/s/g0/c;->X(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lb/j/s/g0/c;->t0(Ljava/lang/CharSequence;)V

    goto :goto_3

    :cond_3
    invoke-virtual {p1, v0}, Lb/j/s/g0/c;->b0(Ljava/lang/CharSequence;)V

    :goto_3
    return-void
.end method

.method public N(ILb/j/s/g0/c;)V
    .locals 6
    ...
    :goto_0
    invoke-virtual {p2, p1}, Lb/j/s/g0/c;->b0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, p1}, Lb/j/s/g0/c;->T(Landroid/graphics/Rect;)V

    sget-object p1, Lb/j/s/g0/c$a;->e:Lb/j/s/g0/c$a;

    invoke-virtual {p2, p1}, Lb/j/s/g0/c;->b(Lb/j/s/g0/c$a;)V
    ...
    invoke-virtual {p2, p1}, Lb/j/s/g0/c;->c0(Z)V

    goto :goto_2

    :cond_2
    invoke-virtual {p2, v0}, Lb/j/s/g0/c;->b0(Ljava/lang/CharSequence;)V
