.class public final Ld/j/b/e/k/a/pj;
...
.method public final bridge synthetic createServiceInterface(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    instance-of v1, v0, Ld/j/b/e/k/a/wj;

    if-eqz v1, :cond_1

    move-object p1, v0

    check-cast p1, Ld/j/b/e/k/a/wj;

    goto :goto_0

    :cond_1
    new-instance v0, Ld/j/b/e/k/a/uj;

    invoke-direct {v0, p1}, Ld/j/b/e/k/a/uj;-><init>(Landroid/os/IBinder;)V
...
.method public final f()Ld/j/b/e/k/a/wj;
    .locals 1
